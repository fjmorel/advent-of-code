namespace Puzzles2021.Day11;

public record Solution(Dictionary<Point, int> _original) : ISolution<Solution>
{
    public static Solution Init(string[] lines) => new(lines.ToDigitGrid());
