namespace Puzzles2021.Day13;

public record Solution(HashSet<Point> _points, List<Solution.Fold> _folds) : ISolution<Solution>
{
    ...
    public async ValueTask<string> GetPart2String()
    {
        ...
        return dots.ToGridString(false).ParseAsciiLetters();
    }
